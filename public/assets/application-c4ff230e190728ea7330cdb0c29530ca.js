...
;
(function() { this.JST || (this.JST = {}); this.JST["maps/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<iframe\n  width=100%\n  height="450"\n  frameborder="0" style="border:0"\n  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDJTPJPSARthXZySPLlPQe6rfK8onyKXg4\n    &q=',  address ,'">\n</iframe>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["menuitems/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  menuitem.get("name") ,'</h3>\n');  menuitem._photos.each(function (photo) { ; __p.push('\n\t  <div class="col-sm-6 col-md-4" id="image-wrapper">\n\t    <a href="#/photos/',  photo.id ,'" class="thumbnail">\n\t     <img src="',  photo.get("filepicker_url") ,'">\n\t    </a>\n\t  </div>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photos/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<center>\t\n\t<h1 id="quote">"All you need is love. But a little chocolate now and then doesn\'t hurt." - Charles M. Schulz</h1>\n\t<form id="new-photo-form">\n\t\t<div id=\'upload-preview\'></div>\n\t    <div id=\'restaurant-rating\'></div>\n\t\t<input type="filepicker"\n\t\t\t   name="photo[filepicker_url]"\n\t\t\t   class="btn btn-primary"\n\t\t\t   data-fp-button-text="Choose an Image"\n\t\t\t   data-fp-mimetype="image/*"\n\t\t\t   data-toggle="collapse"\n\t\t\t   href="#details">\n\n\t\t<input type="submit" value="Upload" class="btn btn-success">\n\t</form>\n</center>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photos/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="nav nav-tabs">\n  <li role="presentation" id="most-liked-li"><a class="most-liked" href="#">Most Likes</a></li>\n  <li role="presentation" id="highest-rated-li"><a href="#" class="highest-rated">Highest Reviews</a></li>\n</ul>\n\n<div class="clearfix" id="allphotos">\n\t');  photos.each(function (photo) { ; __p.push('\n\t  <div class="col-sm-6 col-md-4" id="image-wrapper">\n\t    <a href="#/photos/',  photo.id ,'" class="thumbnail">\n\t     <img src="',  photo.get("filepicker_url") ,'">\n\t    </a>\n\t  </div>\n\t');  }) ; __p.push('\n</div>\n<div class="sk-spinner sk-spinner-rotating-plane" id="spinner"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photos/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img id="string" src="assets/string.png">\n<img id="clothespin" src="assets/clothespin.png">\n<div id="photo-show" tabindex="-1">\n\t<h4><strong>\'',  photo.get("name") ,'\'</strong> -\n\t<a href="#/users/',  photo.get("user_id") ,'">\n\t\t',  user.get("username") ,'\n\t</a>\n\t</h4>\n\t<a href="#/restaurants/',  photo.get("restaurant_id") ,'">\n\t\t',  photo.get("place") ,'\n\t</a> \n\t<a href="#/" id="mapclick">(<i class="fa fa-map-marker"></i> Find it!)</a>\n\t<div id="map-show"></div>\n\t<div id="rating"></div>\n\t<div id="photo-container">\n\t\t<div id="photo-wrapper"><img id="photo" src="',  photo.get("filepicker_url") ,'"></div>\n\t\t<div id="like-mark"></div>\n\t</div>\n\t<div id="who-liked"></div>\n\t<div id="photo-detail">\n\t<p>',  photo.get("review") ,'</p>\n\t</div>\n</div>\n<div><span class="glyphicon glyphicon-chevron-left"></span>\n<span class="glyphicon glyphicon-chevron-right"></span></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  restaurant.get("name") ,'\n<a href="#/" id="mapclick">(<i class="fa fa-map-marker"></i> Find it!)</a>\n</h3>\n<div id="map-show"></div>\n<div id = "restaurant-rating"></div>\n<div id = "restaurant-menu"></div>\n\t<h3>MENU</h3>\n\t');  restaurant._photos.each(function (photo) { ; __p.push('\n\t  <div class="restaurant-menu-item">\n\t\t  <div class="col-sm-6 col-md-4" id="image-wrapper">\n\t\t    <a href="#/photos/',  photo.id ,'" class="thumbnail">\n\t\t     <img src="',  photo.get("filepicker_url") ,'">\n\t\t    </a>\n\t\t  </div>\n\t\t  <div class="restaurant-blurb">\n\t\t\t  <span style="font-size: 20px"><strong>',  photo.get("name") ,'</strong></span>\n\t\t\t  <br>\n\t\t\t  <span>"',  photo.get("review") ,'"</span>\n\t\t  </div>\n\t  </div>\n\t');  }) ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  user.get("username") ,'\'s portfolio</h3>\n\n');  user.photos().each(function (photo) { ; __p.push('\n  <div class="col-sm-6 col-md-4" id="image-wrapper">\n    <a href="#/photos/',  photo.id ,'" class="thumbnail">\n     <img src="',  photo.get("filepicker_url") ,'">\n    </a>\n  </div>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
window.Galbissam.Models.Like = Backbone.Model.extend({
	urlRoot: "api/likes"
})
;
...
window.Galbissam.Collections.Likes = Backbone.Collection.extend({
	url: "api/likes",
	model: Galbissam.Models.Like
});
